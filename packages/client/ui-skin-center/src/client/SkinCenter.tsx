/**
 * The skin-center plugin card: one disclosure card inside the Plugins
 * settings section (设置 → 插件 → 插件配置), listing every installed skin
 ...
 * the host half rewrites the managed skin section through
 * /api/skin-center/apply, the config watcher hot-reloads the patch, and the
 * page reloads into the new skin. Copy rides the standard `t` seat; the
 * theme preview control drives the official theme service.
 */
...
const BACKDROP_SKIN_IDS = new Set(['home', 'blue-fantasy', 'whale-song'])
