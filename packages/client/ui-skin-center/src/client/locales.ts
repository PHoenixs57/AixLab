...
export const en: Record<SkinCenterKey, string> = {
  ...
  backgroundHintInert: 'Only applies to skins that paint a backdrop (AixLab Home / Blue Fantasy / Whale Song). Applies to the official default automatically once such a skin is active.',
}
...
export const zh: Record<SkinCenterKey, string> = {
  ...
  backgroundHintInert: '仅对带背景图插画的皮肤（AixLab 首页 / 蓝色幻想 / 鲸吟）生效；官方默认无背景图，该滑块对这些皮肤自动生效。',
}
