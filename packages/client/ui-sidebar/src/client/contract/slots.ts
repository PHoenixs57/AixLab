...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * Optional favorites section between the browsing region and the foot.
     * Declared by this package's 'sidebar' entry; the literature UI
     * registers the panel. The sidebar passes only its column state.
     */
    'sidebar.favorites': { kind: 'single'; scope: 'root'; owner: SidebarFavoritesOwnerProps }
    /**
...
/** Owner share of the favorites section between the browser and the foot. */
export interface SidebarFavoritesOwnerProps {
  /** Whether the sidebar renders wide content (false = 56px rail). */
  wide: boolean
  /** Rail glyphs request expansion; the panel rides the wide flip for focus. */
  expandSidebar: () => void
}
...
export type SidebarRootComponentProps =
  ...
  & PropsRenderSlots<'sidebar.workspaces' | 'sidebar.favorites' | 'sidebar.settings' | 'sidebar.footer.action'>
