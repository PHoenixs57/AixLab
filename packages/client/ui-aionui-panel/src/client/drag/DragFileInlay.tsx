 ...
 * composer card. While a file row is dragged over the page it shows a hint
 * strip; on drop it inserts a file chip (an inline reference labeled with the
 * file basename) into the active session's draft through the conversation
 * input facade.
 *
...
export interface DragFileInjected {
  /** Insert a file chip for a workspace-relative path into the active session's draft. */
