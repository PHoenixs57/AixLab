 ...
 * binds the three stores to the live client runtime (the active session's cwd
 * is the project root), subscribes to the host fs change stream, and
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => {
    ...
    // Debounced persists (explorer/preview) may be pending when the page
