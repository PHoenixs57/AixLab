...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  literatureAttachments: 'literature.md',
  literatureFavorites: 'literature.md',
  skills: 'skills.md',
  spillStore: 'spill.md',
  storage: 'storage.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  AttachedPaper: 'attached-paper wire record is owned by packages/literature/literature-attachments/src/types.ts',
  AttachedPaperInput: 'attached-paper wire input is owned by packages/literature/literature-attachments/src/types.ts',
  AttachResult: 'attach outcome is owned by packages/literature/literature-attachments/src/types.ts',
  DetachResult: 'detach outcome is owned by packages/literature/literature-attachments/src/types.ts',
  AttachedTurn: 'per-message attached-papers record is owned by packages/literature/literature-attachments/src/types.ts',
  FavoritesAddRequest: 'bookmark wire request is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesAddResult: 'bookmark wire result is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesListResult: 'collection wire result is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesMoveRequest: 'move wire request is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesMoveResult: 'move wire result is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesRemoveRequest: 'unbookmark wire request is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesRemoveResult: 'unbookmark wire result is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesFolderCreateRequest: 'folder-create wire request is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesFolderCreateResult: 'folder-create wire result is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesFolderRenameRequest: 'folder-rename wire request is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesFolderRenameResult: 'folder-rename wire result is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesFolderDeleteRequest: 'folder-delete wire request is owned by packages/literature/literature-favorites/src/types.ts',
  FavoritesFolderDeleteResult: 'folder-delete wire result is owned by packages/literature/literature-favorites/src/types.ts',
