...
| [literature.md](literature.md) | per-session attached papers as session events and injected context, and the durable favorites collection with category folders |
